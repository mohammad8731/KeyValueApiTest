...
namespace AzarDataNetTestAPI.Modules.Common.Domain.Exceptions.Common
{
    ...
    {
        public FillRequiredFeildsException(string lang, [CallerMemberName] string methodName = "default") : base(Messages.FillRequiredFeildsMessage(lang), methodName,(short)HttpStatusCode.BadRequest)
        {
