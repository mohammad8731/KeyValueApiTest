...
namespace AzarDataNetTestAPI.Modules.Common.Domain.Exceptions.Common
{
    ...
    {
        public ExpiredException(string prop, string englishProp, string lang, [CallerMemberName] string methodName = "default") : base(Messages.GetExpiredMessage(prop, englishProp, lang), methodName)
        {
