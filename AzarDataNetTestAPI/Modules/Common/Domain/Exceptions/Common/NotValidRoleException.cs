...
namespace AzarDataNetTestAPI.Modules.Common.Domain.Exceptions.Common
{
    ...
    {
        public NotValidRoleException(string lang, [CallerMemberName] string methodName = "default") : base(Messages.GetNotValidMessage("نقش وارد شده ", "role entered", lang), methodName)
        {
