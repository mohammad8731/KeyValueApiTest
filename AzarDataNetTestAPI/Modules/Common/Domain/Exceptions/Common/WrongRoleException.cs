...
namespace AzarDataNetTestAPI.Modules.Common.Domain.Exceptions.Common
{
    ...
    {
        public WrongRoleException(string lang, [CallerMemberName] string methodName = "default") : base(Messages.GetWrongRoleMessage(lang), methodName,(short)HttpStatusCode.BadRequest)
        {
